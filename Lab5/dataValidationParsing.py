...
def validate_xml_with_xsd(xml_file, xsd_file):
    try:
        ...
        if is_valid:
            ...
            xml_tree = etree.parse("2347203_Lab5.xml")
            xsl_transform = etree.XSLT(etree.parse("2347203_Lab5.xsl"))
...
xml_file_path = "2347203_Lab5.xml"
xsd_file_path = "2347203_Lab5.xsd"
